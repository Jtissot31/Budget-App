...
const FRENCH_LABELS = {
  ...
  LocalPizza: 'Pizza',
  Icecream: 'Glace',
  Nightlife: 'Sortie nocturne',
  // Transport
  DirectionsBike: 'Vélo',
  TwoWheeler: 'Moto',
  LocalTaxi: 'Taxi',
  EvStation: 'Borne électrique',
  // Shopping
  ReceiptLong: 'Reçu',
  Loyalty: 'Fidélité',
  LocalOffer: 'Offre',
  ...
  Spa: 'Spa',
  Healing: 'Soin',
  MonitorHeart: 'Cardiaque',
  Vaccines: 'Vaccin',
  // Entertainment
  SportsSoccer: 'Football',
  SportsBasketball: 'Basket',
  ...
  WbSunny: 'Soleil',
  Thunderstorm: 'Orage',
  AcUnit: 'Climatisation',
  // Social
  Group: 'Groupe',
  PersonAdd: 'Ajouter contact',
  MessageMdi: 'Message',
  EmailMdi: 'Email',
  ShareMdi: 'Partager',
  ThumbUp: 'Aimer',
  ...
  // Services
  LocalLaundryService: 'Laverie',
  DryCleaning: 'Nettoyage à sec',
  CleaningServices: 'Nettoyage',
  LocalCarWash: 'Lavage auto',
  BuildMdi: 'Bricolage',
  Plumbing: 'Plomberie',
  // Travel
  BeachAccess: 'Plage',
  OutdoorGrill: 'Camping',
  MapMdi: 'Carte',
  Explore: 'Explorer',
  Landscape: 'Paysage',
  DirectionsWalk: 'Marche',
  // Extra
  Pets: 'Animaux',
  ChildCare: 'Enfants',
  LocalFlorist: 'Fleuriste',
  Palette: 'Art',
  CameraAlt: 'Appareil photo',
