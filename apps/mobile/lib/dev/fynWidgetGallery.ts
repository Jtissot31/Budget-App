...
export const FYN_WIDGET_GALLERY: FynWidgetGalleryEntry[] = [
  ...
  },
  {
    ...
    subtitle: 'Agrégat — solde avec pill de tendance',
    data: {
  ...
  {
    id: 'balance_summary_card_account',
    typeLabel: 'Carte solde compte',
    subtitle: 'Solde d’un compte précis — logo institution (Tangerine)',
    data: {
      type: 'balance_summary_card',
      variant: 'account',
      label: 'Solde',
      account_id: '1',
      account_name: 'Tangerine Chèque',
      account_institution: 'Tangerine',
      account_last4: '4521',
      account_kind: 'cheque',
      value_label: '3 412,50 $',
      trend_label: '+4 % par rapport au mois dernier',
      positive: true,
