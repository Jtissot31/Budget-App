    ...
    steps: [
      {
        ...
        description: '10 000 $ = ~3 mois de dépenses essentielles.',
        completed: true,
      ...
      },
      {
        ...
        description: '150 $ par semaine vers le compte Épargne · 4521.',
        completed: true,
        dueLabel: 'Terminé en fév. 2026',
      },
      {
        id: '3',
        label: 'Atteindre 75 %',
        description: 'Encore 1 300 $ pour franchir le prochain jalon.',
        completed: false,
      ...
      },
      {
        ...
        description: 'Fonds d’urgence complet — 3 mois de couverture.',
        completed: false,
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        completed: false,
        dueLabel: 'Objectif : chaque dimanche',
      },
      {
        id: '3',
